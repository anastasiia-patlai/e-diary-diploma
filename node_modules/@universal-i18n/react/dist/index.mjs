...
var AutoTranslateContext = createContext({
  locale: "en",
  sourceLocale: "en",
  setLocale: () => {
  },
...
function AutoTranslateProvider({
  ...
  const originalTextsRef = useRef(/* @__PURE__ */ new Map());
  ...
  return /* @__PURE__ */ jsxs(AutoTranslateContext.Provider, { value: contextValue, children: [
    /* @__PURE__ */ jsx("div", { ref: containerRef, "data-i18n-root": "true", children }),
    showSwitcher && resolvedLocales.length > 1 && /* @__PURE__ */ jsx(FloatingLanguageSwitcher, {}),
    isTranslating && /* @__PURE__ */ jsx(TranslatingIndicator, {})
  ] });
}
      ...
      children: [
        open && /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: availableLocales.map((l) => /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => {
                  setLocale(l);
